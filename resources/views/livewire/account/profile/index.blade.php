        ...
        <div class="kt-container-fluid flex items-center justify-between flex-wrap gap-3">
            <div class="flex items-center flex-wrap gap-1 lg:gap-5">
                ...
                <div class="flex items-center gap-1 text-sm font-normal">
                    <a class="text-secondary-foreground hover:text-primary" href="html/demo3.html">
                        Home
                    </a>
            ...
            <div class="flex items-center gap-1">
                <a class="kt-btn kt-btn-outline kt-btn-sm" href="html/demo3/public-profile/profiles/default.html">
                    View Profile
                </a>
            </div>
        </div>
                                ...
                                <div class="kt-menu-item" data-kt-menu-item-offset="0, 10px" data-kt-menu-item-placement="bottom-end" data-kt-menu-item-placement-rtl="bottom-start" data-kt-menu-item-toggle="dropdown" data-kt-menu-item-trigger="click">
                                    ...
                                    <div class="kt-menu-dropdown kt-menu-default w-full max-w-[175px]" data-kt-menu-dismiss="true">
                                        <div class="kt-menu-item">
                                            <a class="kt-menu-link" href="html/demo3/account/home/settings-plain.html">
                ...
                <div class="grid gap-5 lg:gap-7.5">
                    ...
                    <div class="kt-card flex-col gap-5 justify-between bg-[center_top_1.3rem] bg-no-repeat pt-5 lg:pt-10 px-5 start-now-bg bg-[length:700px]">
                        <div class="text-center">
                            ...
                            <a class="kt-btn kt-btn-mono" href="html/demo3/network/user-table/visitors.html">
                                Start Now
                            </a>
                        </div>
                        <div class="text-center">
                                        ...
                                        <td>
                                            <div class="flex items-center grow gap-2.5">
                                                ...
                                                <div class="flex flex-col gap-1">
                                                    <a class="text-sm font-medium text-mono hover:text-primary mb-px" href="html/demo3/public-profile/profiles/creator.html">
                                                        Tyler Hero
                                                    </a>
                    ...
                    <div class="kt-card">
                        ...
                        <div class="kt-card-footer justify-center">
                            <a class="kt-link kt-link-underlined kt-link-dashed" href="html/demo3/account/integrations.html">
                                All Files
                            </a>
                        </div>
                    </div>
