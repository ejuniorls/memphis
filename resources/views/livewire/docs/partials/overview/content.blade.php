...
<div class="mb-10">
    ...
    <p class="text-sm text-gray-500 leading-relaxed max-w-2xl">
        ...
        <x-ui.button tag="a" href="https://ktui.io" ghost="primary" class="inline-flex px-0! gap-1 h-auto!">KTUI
        </x-ui.button>
        e o tema
        <x-ui.button tag="a" href="https://keenthemes.com/metronic" ghost="primary"
                     class="inline-flex px-0! gap-1 h-auto!">Metronic 9
        </x-ui.button>
        ,
...
{{-- Como usar --}}
<section class="mb-10">
    <h2 class="text-base font-semibold text-mono mb-1">Como usar</h2>
    <p class="text-xs text-gray-500 mb-4">
        Todos os componentes ficam em
        <code
            class="text-primary bg-primary/10 px-1.5 py-0.5 rounded text-xs font-mono">resources/views/components/ui/</code>
        e são chamados com o prefixo
        <code class="text-primary bg-primary/10 px-1.5 py-0.5 rounded text-xs font-mono">x-ui.*</code>.
    </p>
    <x-docs.code-preview :preview="false">
        @slot('code')
            <x-ui.button variant="primary" icon="plus">Criar</x-ui.button>

            <x-ui.alert variant="success" title="Salvo!" description="Registro atualizado com sucesso."/>
...
<section>
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3">
        @foreach([
            ...
            ['slug' => 'accordion',  'label' => 'Accordion',  'desc' => 'Seções expansíveis de conteúdo.',                  'icon' => 'lucide-chevrons-up-down', 'stable' => false],
            ['slug' => 'table',      'label' => 'Table',      'desc' => 'Tabelas de dados.',                                'icon' => 'lucide-table',            'stable' => false],
            ['slug' => 'form-input', 'label' => 'Form Input', 'desc' => 'Campos com validação e estados.',                  'icon' => 'lucide-text-cursor-input','stable' => false],
        ] as $comp)
               ...
               class="kt-card hover:shadow-md transition-all group cursor-pointer">
                <div class="kt-card-content p-4">
                    <div class="flex items-start justify-between mb-3">
                        <div
                            class="size-10 rounded-xl bg-primary/10 flex items-center justify-center group-hover:bg-primary/20 transition-colors">
                    ...
                    <div
                        class="flex items-center gap-1 mt-3 text-xs text-primary opacity-0 group-hover:opacity-100 transition-opacity">
                        Ver documentação
