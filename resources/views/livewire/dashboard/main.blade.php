                    ...
                    <div class="kt-card kt-card-grid h-full min-w-full">
                        ...
                        <div class="kt-card-table">
                            <div class="grid datatable-initialized" data-kt-datatable="true"
                                 data-kt-datatable-page-size="5" id="teams_datatable"
                                ...
                                <div class="kt-scrollable-x-auto">
                                    <table class="kt-table kt-table-border table-fixed" data-kt-datatable-table="true"
                                        ...
                                        <tr>
                                            ...
                                            <th class="w-[125px]" aria-sort="none">
                                                <span class="kt-table-col">
                                                    <span class="kt-table-col-label">
                                                        Rating
                                                    </span>
                                            ...
                                            <th class="w-[135px]" aria-sort="none">
                                                <span class="kt-table-col">
                                                    <span class="kt-table-col-label">
                                                        Last Modified
                                                    </span>
                                        ...
                                        <tbody>
                                        <tr>
                                            <td><input class="kt-checkbox kt-checkbox-sm"
                                ...
                                <div
                                    ...
                                    <div class="flex items-center gap-2 order-2 md:order-1">
                                        ...
                                        <div data-kt-select-wrapper="" class="kt-select-wrapper w-16">
                                            <div data-kt-select-display="" class="kt-select-display kt-select"
                                                ...
                                                <div class="kt-select-option-text" data-kt-text-container="true">5</div>
                                            </div>
                                            <div data-kt-select-dropdown="" class="kt-select-dropdown hidden "
                                                ...
                                                <ul role="listbox" aria-label="Select an option"
                                                    ...
                                                    <li data-kt-select-option="" data-value="5" data-text="5"
                                                        ...
                                                        aria-selected="true">
                                                        <div class="kt-select-option-text"
                                                             data-kt-text-container="true">5
                                                        </div>
                                                    ...
                                                    <li data-kt-select-option="" data-value="10" data-text="10"
                                                        ...
                                                        <div class="kt-select-option-text"
                                                             data-kt-text-container="true">10
                                                        </div>
                                                        <svg viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                                             stroke-width="2" stroke-linecap="round"
                                                             stroke-linejoin="round"
                                                    ...
                                                    <li data-kt-select-option="" data-value="20" data-text="20"
                                                        class="kt-select-option" role="option" aria-selected="false">
                                                        <div class="kt-select-option-text"
                                                             data-kt-text-container="true">20
                                                        </div>
                                                        <svg viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                                             stroke-width="2" stroke-linecap="round"
                                                             stroke-linejoin="round"
                                                    ...
                                                    <li data-kt-select-option="" data-value="30" data-text="30"
                                                        class="kt-select-option" role="option" aria-selected="false">
                                                        <div class="kt-select-option-text"
                                                             data-kt-text-container="true">30
                                                        </div>
                                                        <svg viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                                             stroke-width="2" stroke-linecap="round"
                                                             stroke-linejoin="round"
                                                    ...
                                                    <li data-kt-select-option="" data-value="50" data-text="50"
                                                        class="kt-select-option" role="option" aria-selected="false">
                                                        <div class="kt-select-option-text"
                                                             data-kt-text-container="true">50
                                                        </div>
                                                        <svg viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                                             stroke-width="2" stroke-linecap="round"
                                                             stroke-linejoin="round"
                                    ...
                                    <div class="flex items-center gap-4 order-1 md:order-2">
                                        ...
                                        <div class="kt-datatable-pagination" data-kt-datatable-pagination="true">
                                            ...
                                            <button class="kt-datatable-pagination-button active disabled" disabled="">
                                                1
                                            </button>
                                            <button
                                ...
                                <div class="flex items-center gap-2.5">
                                    ...
                                    <div class="flex flex-col gap-0.5">
                                        <a class="flex items-center gap-1.5 leading-none font-medium text-sm text-mono hover:text-primary"
                                           href="html/demo3/public-profile/teams.html">
                                            Esther Howard
                                        </a>
