            ...
            <table width="100%" cellpadding="0" cellspacing="0"
                ...
                <tr>
                    <td style="padding:36px 36px 28px;">
                        ...
                        {{-- Badge --}}
                        <p style="display:inline-block;margin:0 0 20px;font-size:11px;font-weight:500;color:#1e40af;background:#eff6ff;padding:4px 10px;border-radius:20px;border:1px solid #bfdbfe;letter-spacing:0.4px;">
                            BEM-VINDO AO {{ strtoupper(config('app.name')) }}
                        </p>
                        ...
                        <p style="margin:0 0 28px;font-size:15px;color:#6b7280;line-height:1.65;">
                            Sua conta foi criada com sucesso no <strong
                                style="color:#111827;">{{ config('app.name') }}</strong>. Estamos felizes em ter você
                            aqui e animados com o que vem pela frente.
                        </p>
                            ...
                            <tr>
                                <td style="padding:14px 16px;">
                                    <p style="margin:0;font-size:13px;color:#9ca3af;line-height:1.5;">
                                        &#128386; Você receberá em breve um e-mail separado para <strong
                                            style="color:#6b7280;">verificar seu endereço</strong>. Após a verificação,
                                        sua conta estará totalmente ativa.
                                    </p>
                                </td>
                            </tr>
                        </table>
