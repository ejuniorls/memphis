...
<body style="margin:0;padding:0;background-color:#f0f0f0;font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',Roboto,Helvetica,sans-serif;">
            ...
            <table width="100%" cellpadding="0" cellspacing="0"
                ...
                <tr>
                    <td style="background:#0f0f0f;padding:36px;text-align:center;">
                        ...
                        {{-- Icon Box --}}
                        <div style="display:inline-block;width:44px;height:44px;background:rgba(255,255,255,0.08);border-radius:12px;margin-bottom:14px;border:1px solid rgba(255,255,255,0.12);vertical-align:middle;line-height:44px;text-align:center;">
                ...
                <tr>
                    <td style="padding:36px 36px 28px;">
                        ...
                        {{-- Badge --}}
                        <p style="display:inline-block;margin:0 0 20px;font-size:11px;font-weight:500;color:#166534;background:#f0fdf4;padding:4px 10px;border-radius:20px;border:1px solid #bbf7d0;letter-spacing:0.4px;">
                    ...
                    <td>
                        ...
                        <a href="#" style="display:inline-block;margin:0 5px;text-decoration:none;">
                            <table cellpadding="0" cellspacing="0">
                                <tr>
                                    <td style="width:38px;height:38px;background:#ffffff;border-radius:10px;border:1px solid #e5e7eb;text-align:center;vertical-align:middle;">
                                        <svg width="18" height="18" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" style="display:block;margin:auto;">
                                            <path d="M18 2h-3a5 5 0 00-5 5v3H7v4h3v8h4v-8h3l1-4h-4V7a1 1 0 011-1h3z" stroke="#1877F2" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"/>
                                        </svg>
                                    </td>
                                </tr>
                            </table>
                        ...
                        <a href="#" style="display:inline-block;margin:0 5px;text-decoration:none;">
                            <table cellpadding="0" cellspacing="0">
                                <tr>
                                    <td style="width:38px;height:38px;background:#ffffff;border-radius:10px;border:1px solid #e5e7eb;text-align:center;vertical-align:middle;">
                                        <svg width="17" height="17" viewBox="0 0 24 24" fill="#0f0f0f" xmlns="http://www.w3.org/2000/svg" style="display:block;margin:auto;">
                                            <path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-4.714-6.231-5.401 6.231H2.744l7.737-8.835L2.14 2.25H8.5l4.265 5.638L18.244 2.25zm-1.161 17.52h1.833L7.084 4.126H5.117L17.083 19.77z"/>
                                        </svg>
                                    </td>
                                </tr>
                            </table>
                        ...
                        <a href="#" style="display:inline-block;margin:0 5px;text-decoration:none;">
                            <table cellpadding="0" cellspacing="0">
                                <tr>
                                    <td style="width:38px;height:38px;background:#ffffff;border-radius:10px;border:1px solid #e5e7eb;text-align:center;vertical-align:middle;">
                                        <svg width="18" height="18" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" style="display:block;margin:auto;">
                                            <path d="M16 8a6 6 0 016 6v7h-4v-7a2 2 0 00-2-2 2 2 0 00-2 2v7h-4v-7a6 6 0 016-6z" stroke="#0A66C2" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"/>
                                            <rect x="2" y="9" width="4" height="12" stroke="#0A66C2" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"/>
                        ...
                        <a href="#" style="display:inline-block;margin:0 5px;text-decoration:none;">
                            <table cellpadding="0" cellspacing="0">
                                <tr>
                                    <td style="width:38px;height:38px;background:#ffffff;border-radius:10px;border:1px solid #e5e7eb;text-align:center;vertical-align:middle;">
                                        <svg width="18" height="18" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" style="display:block;margin:auto;">
                                            <path d="M22.54 6.42a2.78 2.78 0 00-1.95-1.96C18.88 4 12 4 12 4s-6.88 0-8.59.46A2.78 2.78 0 001.46 6.42 29 29 0 001 12a29 29 0 00.46 5.58 2.78 2.78 0 001.95 1.96C5.12 20 12 20 12 20s6.88 0 8.59-.46a2.78 2.78 0 001.95-1.96A29 29 0 0023 12a29 29 0 00-.46-5.58z" stroke="#FF0000" stroke-width="1.8"/>
                                            <polygon points="9.75 15.02 15.5 12 9.75 8.98 9.75 15.02" stroke="#FF0000" stroke-width="1.8" stroke-linejoin="round"/>
                                        </svg>
                                    </td>
                                </tr>
                            </table>
