...
<div class="{{ config('layout.container') }}">
    <div class="grid gap-5 lg:gap-7.5">
        ...
        <x-ui.breadcrumb>
            ...
            <x-ui.breadcrumb-item active>Novo Usuário</x-ui.breadcrumb-item>
        </x-ui.breadcrumb>
        ...
        <div class="flex items-center gap-3">
            ...
            />
            <div>
                <h1 class="text-xl font-semibold text-mono">Novo Usuário</h1>
                <p class="text-sm text-secondary-foreground mt-0.5">
                    Crie um novo usuário e defina seu acesso ao sistema.
                </p>
            </div>
        </div>
                ...
                <label class="flex items-start gap-3 cursor-pointer">
                    ...
                    <div class="flex flex-col gap-0.5">
                        ...
                        <span class="text-xs text-secondary-foreground">
                            O usuário receberá um e-mail com as instruções de acesso e um link para definir sua própria senha.
                        </span>
                    </div>
                </label>
