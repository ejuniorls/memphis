...
<div x-data="{ activeSection: 'button' }">
    ...
    <div class="kt-container-fluid mb-8">
        <div class="flex flex-col gap-1 pt-2">
            ...
            <p class="text-sm text-secondary-foreground">Biblioteca de componentes Blade reutilizáveis do projeto
                Memphis.</p>
        </div>
    </div>
    ...
    <div class="kt-container-fluid">
        <div class="flex gap-7.5 items-start">
            ...
            <aside class="w-52 shrink-0 sticky top-6">
                <nav class="flex flex-col gap-1">
                    <button @click="activeSection = 'button'"
                            :class="activeSection === 'button' ? 'bg-primary/10 text-primary font-semibold' : 'text-secondary-foreground hover:text-mono hover:bg-muted'"
                            class="text-left text-sm px-3 py-2 rounded-lg transition-colors">Button
                    </button>
                    <button @click="activeSection = 'badge'"
                            :class="activeSection === 'badge' ? 'bg-primary/10 text-primary font-semibold' : 'text-secondary-foreground hover:text-mono hover:bg-muted'"
                            class="text-left text-sm px-3 py-2 rounded-lg transition-colors">Badge
                    </button>
                    <button @click="activeSection = 'alert'"
                            :class="activeSection === 'alert' ? 'bg-primary/10 text-primary font-semibold' : 'text-secondary-foreground hover:text-mono hover:bg-muted'"
                            class="text-left text-sm px-3 py-2 rounded-lg transition-colors">Alert
                    </button>
                    <button @click="activeSection = 'input'"
                            :class="activeSection === 'input' ? 'bg-primary/10 text-primary font-semibold' : 'text-secondary-foreground hover:text-mono hover:bg-muted'"
                            class="text-left text-sm px-3 py-2 rounded-lg transition-colors">Input
                    </button>
                    <button @click="activeSection = 'input-group'"
                            :class="activeSection === 'input-group' ? 'bg-primary/10 text-primary font-semibold' : 'text-secondary-foreground hover:text-mono hover:bg-muted'"
                            class="text-left text-sm px-3 py-2 rounded-lg transition-colors">Input Group
                    </button>
                    <button @click="activeSection = 'select'"
                            :class="activeSection === 'select' ? 'bg-primary/10 text-primary font-semibold' : 'text-secondary-foreground hover:text-mono hover:bg-muted'"
                            class="text-left text-sm px-3 py-2 rounded-lg transition-colors">Select
                    </button>
                    <button @click="activeSection = 'link'"
                            :class="activeSection === 'link' ? 'bg-primary/10 text-primary font-semibold' : 'text-secondary-foreground hover:text-mono hover:bg-muted'"
                            class="text-left text-sm px-3 py-2 rounded-lg transition-colors">Link
                    </button>
                    <button @click="activeSection = 'icon-box'"
                            :class="activeSection === 'icon-box' ? 'bg-primary/10 text-primary font-semibold' : 'text-secondary-foreground hover:text-mono hover:bg-muted'"
                            class="text-left text-sm px-3 py-2 rounded-lg transition-colors">Icon Box
                    </button>
                    <button @click="activeSection = 'breadcrumb'"
                            :class="activeSection === 'breadcrumb' ? 'bg-primary/10 text-primary font-semibold' : 'text-secondary-foreground hover:text-mono hover:bg-muted'"
                            class="text-left text-sm px-3 py-2 rounded-lg transition-colors">Breadcrumb
                    </button>
                    <button @click="activeSection = 'toast'"
                            :class="activeSection === 'toast' ? 'bg-primary/10 text-primary font-semibold' : 'text-secondary-foreground hover:text-mono hover:bg-muted'"
                            class="text-left text-sm px-3 py-2 rounded-lg transition-colors">Toast
                    </button>
                    <button @click="activeSection = 'modal'"
                            :class="activeSection === 'modal' ? 'bg-primary/10 text-primary font-semibold' : 'text-secondary-foreground hover:text-mono hover:bg-muted'"
                            class="text-left text-sm px-3 py-2 rounded-lg transition-colors">Modal
                    </button>
                    <button @click="activeSection = 'accordion'"
                            :class="activeSection === 'accordion' ? 'bg-primary/10 text-primary font-semibold' : 'text-secondary-foreground hover:text-mono hover:bg-muted'"
                            class="text-left text-sm px-3 py-2 rounded-lg transition-colors">Accordion
                    </button>
                </nav>
            </aside>
        ...
        BLADE;
                    @endphp
                    <x-ui-doc-section title="Button - Variantes"
                                      description="Prop <code>variant</code> define a cor semântica do botão."
                                      :code="$code">
        ...
        BLADE;
                    @endphp
                    <x-ui-doc-section title="Button - Tamanhos"
                                      description="Prop <code>size</code>: <code>xs</code>, <code>sm</code>, padrão, <code>lg</code>."
                                      :code="$code">
        ...
        BLADE;
                    @endphp
                    <x-ui-doc-section title="Button - Com ícone"
                                      description="Props <code>icon</code> e <code>iconEnd</code> aceitam qualquer nome Lucide."
                                      :code="$code">
                        <div class="flex flex-wrap items-center gap-3">
                            <x-ui.button variant="primary" icon="plus">Novo</x-ui.button>
                            <x-ui.button variant="secondary" iconEnd="arrow-right">Próximo</x-ui.button>
        ...
        BLADE;
                    @endphp
                    <x-ui-doc-section title="Button - Ghost & Disabled"
                                      description="Botões sem fundo via prop <code>ghost</code> e estado desabilitado."
                                      :code="$code">
                        <div class="flex flex-wrap items-center gap-3">
                            <x-ui.button ghost="">Ghost</x-ui.button>
                            <x-ui.button ghost="primary">Ghost Primary</x-ui.button>
        ...
        BLADE;
                    @endphp
                    <x-ui-doc-section title="Badge - Variantes"
                                      description="Prop <code>variant</code> define a cor semântica." :code="$code">
        ...
        BLADE;
                    @endphp
                    <x-ui-doc-section title="Badge - Estilos"
                                      description="Prop <code>style</code>: <code>outline</code>, <code>light</code>, <code>ghost</code>."
                                      :code="$code">
                        <div class="flex flex-wrap gap-2">
                            <x-ui.badge variant="primary" style="outline">Outline</x-ui.badge>
                            <x-ui.badge variant="success" style="light">Light</x-ui.badge>
        ...
        BLADE;
                    @endphp
                    <x-ui-doc-section title="Badge - Dot, ícone e removível"
                                      description="Props <code>dot</code>, <code>icon</code> e <code>removable</code> para indicadores extras."
                                      :code="$code">
                        <div class="flex flex-wrap gap-2">
                            <x-ui.badge variant="success" :dot="true">Online</x-ui.badge>
                            <x-ui.badge variant="primary" icon="star">Destaque</x-ui.badge>
        ...
        BLADE;
                    @endphp
                    <x-ui-doc-section title="Input - Tamanhos"
                                      description="Prop <code>size</code>: <code>sm</code>, padrão, <code>lg</code>."
                                      :code="$code">
        ...
        BLADE;
                    @endphp
                    <x-ui-doc-section title="Input - Com ícone e estado de erro"
                                      description="Props <code>icon</code>, <code>iconEnd</code> e <code>:invalid</code>."
                                      :code="$code">
                        <div class="flex flex-col gap-3 max-w-xs">
                            <x-ui.input icon="search" placeholder="Buscar..."/>
                            <x-ui.input icon="mail" iconEnd="eye" placeholder="email@exemplo.com" type="email"/>
        ...
        BLADE;
                    @endphp
                    <x-ui-doc-section title="Input Group - Addon de texto"
                                      description="Props <code>addon</code> e <code>addonEnd</code> adicionam texto antes/após o input."
                                      :code="$code">
                        <div class="flex flex-col gap-3 max-w-xs">
                            <x-ui.input-group addon="https://">
                                <x-ui.input placeholder="seusite.com"/>
        ...
        BLADE;
                    @endphp
                    <x-ui-doc-section title="Input Group - Addon com ícone"
                                      description="Props <code>addonIcon</code> e <code>addonIconEnd</code> para ícones Lucide."
                                      :code="$code">
                        <div class="flex flex-col gap-3 max-w-xs">
                            <x-ui.input-group addonIcon="search">
                                <x-ui.input placeholder="Buscar usuário..."/>
        ...
        BLADE;
                    @endphp
                    <x-ui-doc-section title="Select - Básico"
                                      description="Select nativo potencializado pelo KT Select. Prop <code>placeholder</code> para texto inicial."
                                      :code="$code">
                        <div class="max-w-xs">
                            <x-ui.select placeholder="Escolha uma opção">
                                <option value="1">Opção 1</option>
        ...
        BLADE;
                    @endphp
                    <x-ui-doc-section title="Select - Com busca"
                                      description="Prop <code>:search=&quot;true&quot;</code> adiciona campo de busca no dropdown."
                                      :code="$code">
                        <div class="max-w-xs">
                            <x-ui.select placeholder="Selecione o país" :search="true"
        ...
        BLADE;
                    @endphp
                    <x-ui-doc-section title="Link - Variações"
                                      description="Props <code>underline</code>, <code>underlined</code>, <code>dashed</code>, <code>mono</code>."
                                      :code="$code">
        ...
        BLADE;
                    @endphp
                    <x-ui-doc-section title="Link - Com ícone e tamanhos"
                                      description="Props <code>icon</code>, <code>iconEnd</code> e <code>size</code>: <code>sm</code>, padrão, <code>lg</code>."
                                      :code="$code">
        ...
        BLADE;
                    @endphp
                    <x-ui-doc-section title="Icon Box - Tamanhos"
                                      description="Prop <code>size</code>: <code>sm</code>, <code>md</code>, <code>lg</code>, <code>xl</code>."
                                      :code="$code">
                        <div class="flex flex-wrap items-center gap-4">
                            <x-ui.icon-box icon="settings" size="sm"/>
                            <x-ui.icon-box icon="settings" size="md"/>
        ...
        BLADE;
                    @endphp
                    <x-ui-doc-section title="Icon Box - Cores e raio"
                                      description="Props <code>bg</code>, <code>color</code> e <code>radius</code>: <code>sm</code>, <code>md</code>, <code>lg</code>, <code>full</code>."
                                      :code="$code">
                        <div class="flex flex-wrap items-center gap-4">
                            <x-ui.icon-box icon="check" bg="bg-success/10" color="text-success"/>
                            <x-ui.icon-box icon="triangle-alert" bg="bg-warning/10" color="text-warning"/>
        ...
        BLADE;
                    @endphp
                    <x-ui-doc-section title="Breadcrumb - Padrão"
                                      description="Container <code>x-ui.breadcrumb</code> com items filhos <code>x-ui.breadcrumb-item</code>."
                                      :code="$code">
                        <x-ui.breadcrumb>
                            <x-ui.breadcrumb-item href="#" :first="true">Home</x-ui.breadcrumb-item>
                            <x-ui.breadcrumb-item href="#">Configurações</x-ui.breadcrumb-item>
        ...
        BLADE;
                    @endphp
                    <x-ui-doc-section title="Breadcrumb - Separador dot"
                                      description="Prop <code>separator=&quot;dot&quot;</code> usa bolinha como separador."
                                      :code="$code">
                        <x-ui.breadcrumb>
                            <x-ui.breadcrumb-item href="#" :first="true" separator="dot">Home</x-ui.breadcrumb-item>
                            <x-ui.breadcrumb-item href="#" separator="dot">Usuários</x-ui.breadcrumb-item>
        ...
        BLADE;
                    @endphp
                    <x-ui-doc-section title="Breadcrumb - Com ícone"
                                      description="Prop <code>icon</code> substitui o texto por um ícone Lucide no item."
                                      :code="$code">
                        <x-ui.breadcrumb>
                            <x-ui.breadcrumb-item href="#" icon="house" :first="true"></x-ui.breadcrumb-item>
                            <x-ui.breadcrumb-item href="#">Relatórios</x-ui.breadcrumb-item>
    ...
    BLADE;
                    @endphp
                    <x-ui-doc-section title="Toast - Uso básico"
                                      description="O Toast é acionado via JavaScript com <code>KTToast.show(options)</code>."
                                      :code="$code">
                        <div class="flex flex-wrap gap-3">
                            <x-ui.button variant="outline"
                                         onclick="KTToast.show({ message: 'Operação realizada com sucesso!' })">Show
                                Toast
                            </x-ui.button>
                        </div>
                    </x-ui-doc-section>
    ...
    BLADE;
                    @endphp
                    <x-ui-doc-section title="Toast - Variantes"
                                      description="Prop <code>variant</code> define a cor semântica do toast."
                                      :code="$code">
                        <div class="flex flex-wrap gap-3">
                            <x-ui.button variant="outline" class="text-success"
                                         onclick="KTToast.show({ message: 'Salvo com sucesso!', variant: 'success' })">
                                Success
                            </x-ui.button>
                            <x-ui.button variant="outline" class="text-warning"
                                         onclick="KTToast.show({ message: 'Atenção: revise antes de continuar.', variant: 'warning' })">
                                Warning
                            </x-ui.button>
                            <x-ui.button variant="outline" class="text-destructive"
                                         onclick="KTToast.show({ message: 'Erro ao processar solicitação.', variant: 'destructive' })">
                                Destructive
                            </x-ui.button>
                            <x-ui.button variant="outline" class="text-primary"
                                         onclick="KTToast.show({ message: 'Nova atualização disponível.', variant: 'primary' })">
                                Primary
                            </x-ui.button>
                            <x-ui.button variant="outline"
                                         onclick="KTToast.show({ message: 'Informação importante.', variant: 'info' })">
                                Info
                            </x-ui.button>
                            <x-ui.button variant="outline"
                                         onclick="KTToast.show({ message: 'Notificação padrão.', variant: 'mono' })">
                                Mono
                            </x-ui.button>
                            <x-ui.button variant="outline"
                                         onclick="KTToast.show({ message: 'Mensagem secundária.', variant: 'secondary' })">
                                Secondary
                            </x-ui.button>
                        </div>
                    </x-ui-doc-section>
    ...
    BLADE;
                    @endphp
                    <x-ui-doc-section title="Toast - Appearance"
                                      description="Prop <code>appearance</code>: <code>solid</code> (padrão), <code>outline</code>, <code>light</code>."
                                      :code="$code">
                        <div class="flex flex-wrap gap-3">
                            <x-ui.button variant="outline"
                                         onclick="KTToast.show({ message: 'Toast sólido (padrão).', variant: 'primary' })">
                                Solid
                            </x-ui.button>
                            <x-ui.button variant="outline"
                                         onclick="KTToast.show({ message: 'Toast com contorno.', variant: 'primary', appearance: 'outline' })">
                                Outline
                            </x-ui.button>
                            <x-ui.button variant="outline"
                                         onclick="KTToast.show({ message: 'Toast com fundo suave.', variant: 'primary', appearance: 'light' })">
                                Light
                            </x-ui.button>
                        </div>
                    </x-ui-doc-section>
    ...
    BLADE;
                    @endphp
                    <x-ui-doc-section title="Toast - Posição"
                                      description="Prop <code>position</code> define onde o toast aparece na tela."
                                      :code="$code">
                        <div class="flex flex-wrap gap-3">
                            <x-ui.button variant="outline"
    ...
    BLADE;
                    @endphp
                    <x-ui-doc-section title="Toast - Tamanho"
                                      description="Prop <code>size</code>: <code>sm</code>, padrão, <code>lg</code>."
                                      :code="$code">
                        <div class="flex flex-wrap gap-3">
                            <x-ui.button variant="outline"
                                         onclick="KTToast.show({ message: 'Toast pequeno.', size: 'sm' })">Small
                            </x-ui.button>
                            <x-ui.button variant="outline" onclick="KTToast.show({ message: 'Toast médio (padrão).' })">
                                Medium
                            </x-ui.button>
                            <x-ui.button variant="outline"
                                         onclick="KTToast.show({ message: 'Toast grande.', size: 'lg' })">Large
                            </x-ui.button>
                        </div>
                    </x-ui-doc-section>
    ...
    BLADE;
                    @endphp
                    <x-ui-doc-section title="Toast - Com título"
                                      description="Prop <code>title</code> adiciona um título acima da mensagem."
                                      :code="$code">
                        <div class="flex flex-wrap gap-3">
                            <x-ui.button variant="outline"
                                         onclick="KTToast.show({ title: 'Salvo com sucesso', message: 'Suas alterações foram salvas.', variant: 'success' })">
                                Com título (success)
                            </x-ui.button>
                            <x-ui.button variant="outline"
                                         onclick="KTToast.show({ title: 'Erro ao salvar', message: 'Não foi possível salvar. Tente novamente.', variant: 'destructive' })">
                                Com título (erro)
                            </x-ui.button>
                        </div>
                    </x-ui-doc-section>
    ...
    BLADE;
                    @endphp
                    <x-ui-doc-section title="Toast - Ícone"
                                      description="Prop <code>icon</code> aceita nome Lucide. Use <code>false</code> para ocultar."
                                      :code="$code">
                        <div class="flex flex-wrap gap-3">
                            <x-ui.button variant="outline"
                                         onclick="KTToast.show({ message: 'Toast com ícone customizado.', icon: 'rocket' })">
                                Ícone customizado
                            </x-ui.button>
                            <x-ui.button variant="outline"
                                         onclick="KTToast.show({ message: 'Toast sem ícone.', icon: false })">Sem ícone
                            </x-ui.button>
                        </div>
                    </x-ui-doc-section>
    ...
    BLADE;
                    @endphp
                    <x-ui-doc-section title="Toast - Progresso"
                                      description="Prop <code>progress: true</code> exibe barra de progresso do tempo restante."
                                      :code="$code">
                        <div class="flex flex-wrap gap-3">
                            <x-ui.button variant="outline"
                                         onclick="KTToast.show({ message: 'Este toast fecha automaticamente.', variant: 'primary', duration: 5000, progress: true })">
                                Com progresso
                            </x-ui.button>
                        </div>
                    </x-ui-doc-section>
    ...
    BLADE;
                    @endphp
                    <x-ui-doc-section title="Toast - Ação & Cancelar"
                                      description="Props <code>action</code> e <code>cancel</code> adicionam botões de ação ao toast."
                                      :code="$code">
                        <div class="flex flex-wrap gap-3">
                            <x-ui.button variant="outline"
                                         onclick="KTToast.show({ message: 'Registro excluído.', variant: 'destructive', action: { label: 'Desfazer', onClick: function(id){ console.log('Undo', id) } }, cancel: { label: 'Ignorar', onClick: function(id){ KTToast.hide(id) } } })">
                                Ação & Cancelar
                            </x-ui.button>
                        </div>
                    </x-ui-doc-section>
    ...
    BLADE;
                    @endphp
                    <x-ui-doc-section title="Toast - Duração"
                                      description="Prop <code>duration</code> em ms. Use <code>0</code> para toast permanente."
                                      :code="$code">
                        <div class="flex flex-wrap gap-3">
                            <x-ui.button variant="outline"
                                         onclick="KTToast.show({ message: 'Este toast dura 10 segundos.', duration: 10000 })">
                                10 segundos
                            </x-ui.button>
                            <x-ui.button variant="outline"
                                         onclick="KTToast.show({ message: 'Este toast não fecha sozinho.', duration: 0, dismissible: true })">
                                Permanente
                            </x-ui.button>
                        </div>
                    </x-ui-doc-section>
    ...
    BLADE;
                    @endphp
                    <x-ui-doc-section title="Toast - Importante"
                                      description="Prop <code>important: true</code> persiste o toast mesmo durante navegação."
                                      :code="$code">
                        <div class="flex flex-wrap gap-3">
                            <x-ui.button variant="outline"
                                         onclick="KTToast.show({ message: 'Toast importante - não é removido ao navegar.', variant: 'warning', important: true })">
                                Importante
                            </x-ui.button>
    ...
    BLADE;
                    @endphp
                    <x-ui-doc-section title="Toast - Pause on Hover"
                                      description="Prop <code>pauseOnHover</code> pausa o temporizador quando o mouse está sobre o toast."
                                      :code="$code">
                        <div class="flex flex-wrap gap-3">
                            <x-ui.button variant="outline"
                                         onclick="KTToast.show({ message: 'Passe o mouse para pausar.', pauseOnHover: true, duration: 6000, progress: true })">
                                Pausa no hover
                            </x-ui.button>
                            <x-ui.button variant="outline"
                                         onclick="KTToast.show({ message: 'Hover não pausa este toast.', pauseOnHover: false, duration: 6000, progress: true })">
                                Sem pausa
                            </x-ui.button>
                        </div>
                    </x-ui-doc-section>
    ...
    BLADE;
                    @endphp
                    <x-ui-doc-section title="Toast - Componente Blade estático"
                                      description="O componente <code>&lt;x-ui.toast&gt;</code> gera a estrutura HTML sem JS. Use a API <code>KTToast.show()</code> para comportamento dinâmico."
                                      :code="$code">
                        <div class="text-sm text-secondary-foreground bg-muted/40 rounded-lg p-4 border border-input">
                            ...
                            <p>O componente Blade é ideal para toasts gerados server-side (ex: flash messages do
                                Laravel). Para toasts disparados por interação do usuário, use <code
                                    class="text-xs bg-muted px-1 py-0.5 rounded">KTToast.show()</code>.</p>
                        </div>
                    </x-ui-doc-section>
    ...
    BLADE;
                    @endphp
                    <x-ui-doc-section title="Modal - Uso básico"
                                      description="Conecte o botão via <code>data-kt-modal-toggle</code> e o componente via <code>id</code>."
                                      :code="$code">
                        <div class="flex flex-wrap gap-3">
    ...
    BLADE;
                    @endphp
                    <x-ui-doc-section title="Modal - Com footer"
                                      description="Use o slot <code>footer</code> para adicionar botões de ação."
                                      :code="$code">
                        <div class="flex flex-wrap gap-3">
                        ...
                        <x-ui.modal id="modal_footer" title="Confirmar ação" top="5%">
                            ...
                            <x-slot:footer>
                                <x-ui.button variant="secondary" data-kt-modal-dismiss="#modal_footer">Cancelar
                                </x-ui.button>
                                <x-ui.button variant="primary">Confirmar</x-ui.button>
                            </x-slot:footer>
                        </x-ui.modal>
    ...
    BLADE;
                    @endphp
                    <x-ui-doc-section title="Modal - Centralizado"
                                      description="Prop <code>center</code> posiciona o modal centralizado vertical e horizontalmente."
                                      :code="$code">
                        <div class="flex flex-wrap gap-3">
                            <x-ui.button variant="outline" data-kt-modal-toggle="#modal_center">Centralizado
                            </x-ui.button>
                        </div>
                        ...
                        <x-ui.modal id="modal_center" title="Modal centralizado" :center="true">
                            ...
                            <x-slot:footer>
                                <x-ui.button variant="secondary" data-kt-modal-dismiss="#modal_center">Fechar
                                </x-ui.button>
                                <x-ui.button variant="primary">Salvar</x-ui.button>
                            </x-slot:footer>
                        </x-ui.modal>
    ...
    BLADE;
                    @endphp
                    <x-ui-doc-section title="Modal - Tamanhos"
                                      description="Prop <code>size</code>: <code>sm</code>, padrão (400px), <code>lg</code>, <code>xl</code>."
                                      :code="$code">
                        <div class="flex flex-wrap gap-3">
    ...
    BLADE;
                    @endphp
                    <x-ui-doc-section title="Modal - Scrollable"
                                      description="Prop <code>scrollable</code> ativa scroll interno no body. Use <code>maxBodyHeight</code> para controlar a altura."
                                      :code="$code">
                        <div class="flex flex-wrap gap-3">
                            <x-ui.button variant="outline" data-kt-modal-toggle="#modal_scroll">Scrollable</x-ui.button>
                        </div>

                        <x-ui.modal id="modal_scroll" title="Conteúdo longo" :scrollable="true" maxBodyHeight="260px"
                                    top="10%">
                            <div class="rounded-lg bg-muted w-full h-[600px]"></div>
                            <x-slot:footer>
                                <x-ui.button variant="secondary" data-kt-modal-dismiss="#modal_scroll">Cancelar
                                </x-ui.button>
                                <x-ui.button variant="primary">Salvar</x-ui.button>
                            </x-slot:footer>
                        </x-ui.modal>
    ...
    BLADE;
                    @endphp
                    <x-ui-doc-section title="Modal - Backdrop"
                                      description="<code>backdropStatic</code> impede fechar ao clicar fora. <code>:backdrop=&quot;false&quot;</code> remove o fundo escuro."
                                      :code="$code">
                        <div class="flex flex-wrap gap-3">
                            <x-ui.button variant="outline" data-kt-modal-toggle="#modal_static">Backdrop estático
                            </x-ui.button>
                            <x-ui.button variant="outline" data-kt-modal-toggle="#modal_no_backdrop">Sem backdrop
                            </x-ui.button>
                        </div>

                        <x-ui.modal id="modal_static" title="Backdrop estático" :backdropStatic="true" top="10%">
                            <p class="text-sm text-secondary-foreground">Clicar fora deste modal não o fecha. Use o
                                botão para fechar.</p>
                            <x-slot:footer>
                                <x-ui.button variant="secondary" data-kt-modal-dismiss="#modal_static">Fechar
                                </x-ui.button>
                            </x-slot:footer>
                        </x-ui.modal>
                        ...
                        <x-ui.modal id="modal_no_backdrop" title="Sem backdrop" :backdrop="false" :center="true">
                            ...
                            <x-slot:footer>
                                <x-ui.button variant="secondary" data-kt-modal-dismiss="#modal_no_backdrop">Fechar
                                </x-ui.button>
                            </x-slot:footer>
                        </x-ui.modal>
                    </x-ui-doc-section>
    ...
    BLADE;
                    @endphp
                    <x-ui-doc-section title="Modal - Header customizado"
                                      description="Use o slot <code>header</code> para substituir completamente o cabeçalho padrão."
                                      :code="$code">
                        <div class="flex flex-wrap gap-3">
                            <x-ui.button variant="outline" data-kt-modal-toggle="#modal_custom_header">Header
                                customizado
                            </x-ui.button>
                        </div>
                        ...
                        <x-ui.modal id="modal_custom_header" top="10%">
                            <x-slot:header>
                                <div class="flex items-center gap-3">
                                    <div
                                        class="flex items-center justify-center size-9 rounded-lg bg-destructive/10 text-destructive shrink-0">
                                        @svg('lucide-trash-2', ['class' => 'size-4'])
                                    </div>
                                    <div>
                                        <h3 class="kt-modal-title">Excluir registro</h3>
                                ...
                                <button type="button" class="kt-modal-close" aria-label="Fechar"
                                        data-kt-modal-dismiss="#modal_custom_header">
                                    @svg('lucide-x')
                                </button>
                            </x-slot:header>
                            <p class="text-sm text-secondary-foreground">
                                Tem certeza que deseja excluir este registro? Todos os dados relacionados serão
                                removidos permanentemente.
                            </p>
                            <x-slot:footer>
                                <x-ui.button variant="secondary" data-kt-modal-dismiss="#modal_custom_header">Cancelar
                                </x-ui.button>
                                <x-ui.button variant="destructive" icon="trash-2">Excluir</x-ui.button>
                            </x-slot:footer>
                        </x-ui.modal>
    ...
    BLADE;
                    @endphp
                    <x-ui-doc-section title="Modal - Alinhamento do footer"
                                      description="Prop <code>footerAlign</code>: <code>end</code> (padrão), <code>start</code>, <code>between</code>."
                                      :code="$code">
                        <div class="flex flex-wrap gap-3">
                            <x-ui.button variant="outline" data-kt-modal-toggle="#modal_footer_end">Footer End
                            </x-ui.button>
                            <x-ui.button variant="outline" data-kt-modal-toggle="#modal_footer_between">Footer Between
                            </x-ui.button>
                        </div>
                        ...
                        <x-ui.modal id="modal_footer_end" title="Footer - End" footerAlign="end" top="10%">
                            ...
                            <x-slot:footer>
                                <x-ui.button variant="secondary" data-kt-modal-dismiss="#modal_footer_end">Cancelar
                                </x-ui.button>
                                <x-ui.button variant="primary">Salvar</x-ui.button>
                            </x-slot:footer>
                        </x-ui.modal>
                        ...
                        <x-ui.modal id="modal_footer_between" title="Footer - Between" footerAlign="between" top="10%">
                            <div class="rounded-lg bg-muted w-full h-32"></div>
                            <x-slot:footer>
                                <x-ui.button variant="secondary" data-kt-modal-dismiss="#modal_footer_between">
                                    Cancelar
                                </x-ui.button>
                                <x-ui.button variant="primary">Salvar</x-ui.button>
                            </x-slot:footer>
    ...
    BLADE;
                    @endphp
                    <x-ui-doc-section title="Modal - Com formulário"
                                      description="Exemplo prático com campos de formulário dentro do modal."
                                      :code="$code">
                        <div class="flex flex-wrap gap-3">
                            <x-ui.button variant="primary" icon="user-plus" data-kt-modal-toggle="#modal_form">Novo
                                usuário
                            </x-ui.button>
                        </div>
                        ...
                        <x-ui.modal id="modal_form" title="Novo usuário" top="8%" size="lg">
                            ...
                            <x-slot:footer>
                                <x-ui.button variant="secondary" data-kt-modal-dismiss="#modal_form">Cancelar
                                </x-ui.button>
                                <x-ui.button variant="primary" icon="user-plus">Criar usuário</x-ui.button>
                            </x-slot:footer>
                        </x-ui.modal>
    ...
    BLADE;
                    @endphp
                    <x-ui-doc-section title="Accordion - Padrão"
                                      description="Estrutura básica: apenas um item aberto por vez." :code="$code">
                        <x-ui.accordion>
                            <x-ui.accordion-item title="Como é determinado o preço de cada plano?">
                                Os planos são calculados com base no número de usuários e recursos utilizados.
                            </x-ui.accordion-item>
    ...
    BLADE;
                    @endphp
                    <x-ui-doc-section title="Accordion - Item aberto por padrão"
                                      description="Prop <code>open</code> no item expande-o na carga inicial."
                                      :code="$code">
                        <x-ui.accordion>
                            <x-ui.accordion-item title="Este item começa aberto" :open="true">
    ...
    BLADE;
                    @endphp
                    <x-ui-doc-section title="Accordion - Múltiplos abertos (expandAll)"
                                      description="Prop <code>expandAll</code> permite que vários itens fiquem abertos ao mesmo tempo."
                                      :code="$code">
                        <x-ui.accordion :expandAll="true">
                            <x-ui.accordion-item title="Suporte técnico 24/7">
                                Nossa equipe está disponível a qualquer hora para resolver suas dúvidas.
                    ...
                    @php
                        $code = <<<'BLADE'
    <x-ui.accordion :outline="true" :expandAll="true">
        <x-ui.accordion-item title="Qual é a política de reembolso?">
            Oferecemos reembolso integral em até 14 dias após a contratação, sem perguntas.
        </x-ui.accordion-item>
        <x-ui.accordion-item title="Como funciona a migração de dados?">
            Nossa equipe cuida de toda a migração gratuitamente para planos anuais.
        </x-ui.accordion-item>
        <x-ui.accordion-item title="Quais formas de pagamento são aceitas?">
            Aceitamos cartão de crédito, boleto bancário e Pix.
        </x-ui.accordion-item>
    </x-ui.accordion>
    BLADE;
                    @endphp
                    <x-ui-doc-section title="Accordion - Outline Style"
                                      description="Prop <code>outline</code> aplica <code>kt-accordion-outline</code>, adicionando bordas em cada item."
                                      :code="$code">
                        <x-ui.accordion :outline="true" :expandAll="true">
                            <x-ui.accordion-item title="Qual é a política de reembolso?">
                                Oferecemos reembolso integral em até 14 dias após a contratação, sem perguntas.
    ...
    BLADE;
                    @endphp
                    <x-ui-doc-section title="Accordion - Indicador plus/minus"
                                      description="Prop <code>indicator</code> como <code>plus-minus</code> troca o chevron por + e −."
                                      :code="$code">
                        <x-ui.accordion>
                            <x-ui.accordion-item title="Qual é a política de reembolso?" indicator="plus-minus">
                                Oferecemos reembolso integral em até 14 dias após a contratação, sem perguntas.
    ...
    BLADE;
                    @endphp
                    <x-ui-doc-section title="Accordion - Flushed"
                                      description="Prop <code>flushed</code> remove as bordas laterais, alinhando ao container pai."
                                      :code="$code">
                        <x-ui.accordion :flushed="true">
                            <x-ui.accordion-item title="Modo escuro disponível">
                                Alterne entre tema claro e escuro nas configurações de aparência.
    ...
    BLADE;
                    @endphp
                    <x-ui-doc-section title="Accordion - Separated"
                                      description="Prop <code>separated</code> adiciona espaçamento entre os itens."
                                      :code="$code">
                        <x-ui.accordion :separated="true">
                            <x-ui.accordion-item title="Onboarding guiado">
                                Nosso assistente de configuração leva você do zero ao produto em minutos.
    ...
    BLADE;
                    @endphp
                    <x-ui-doc-section title="Accordion - Com ícone no título"
                                      description="Prop <code>icon</code> exibe um ícone Lucide à esquerda do título do item."
                                      :code="$code">
                        <x-ui.accordion>
                            <x-ui.accordion-item title="Segurança dos dados" icon="shield-check">
                                Utilizamos criptografia AES-256 em repouso e TLS 1.3 em trânsito.
    ...
    BLADE;
                    @endphp
                    <x-ui-doc-section title="Accordion - Item desabilitado"
                                      description="Prop <code>disabled</code> impede a interação com o item."
                                      :code="$code">
                        <x-ui.accordion>
                            <x-ui.accordion-item title="Plano disponível">
                                Este item está habilitado e pode ser clicado normalmente.
    ...
    <div class="sm:w-56 border border-border rounded-md p-2">
        <ul data-kt-accordion="true" class="kt-accordion-menu">
            <li class="kt-accordion-menu-item selected" data-kt-accordion-item="true">
                <a href="#" class="kt-accordion-menu-link">Dashboard</a>
            </li>
            <li class="kt-accordion-menu-item" data-kt-accordion-item="true">
                <button data-kt-accordion-toggle="true" id="menu_users" aria-controls="menu_users_sub" class="kt-accordion-menu-toggle">
                    Usuários
                </button>
                <div id="menu_users_sub" class="kt-accordion-menu-content hidden" aria-labelledby="menu_users">
                    <ul class="kt-accordion-menu-sub">
                        <li data-kt-accordion-item="true"><a href="#" class="kt-accordion-menu-link">Lista</a></li>
                        <li data-kt-accordion-item="true"><a href="#" class="kt-accordion-menu-link">Permissões</a></li>
                    </ul>
                </div>
            </li>
            <li data-kt-accordion-item="true">
                <a href="#" class="kt-accordion-menu-link">Configurações</a>
            </li>
        </ul>
    </div>
    BLADE;
                    @endphp
                    <x-ui-doc-section title="Accordion - Navigation Menu"
                                      description="Use <code>kt-accordion-menu</code> para menus de navegação colapsáveis com suporte a múltiplos níveis."
                                      :code="$code">
                        <div class="sm:w-56 border border-border rounded-md p-2">
                            <ul data-kt-accordion="true" class="kt-accordion-menu">
                                <li class="kt-accordion-menu-item selected" data-kt-accordion-item="true">
                                    <a href="#" class="kt-accordion-menu-link">
                                        @svg('lucide-house', ['class' => 'lucide lucide-house kt-accordion-menu-icon'])
                                        Dashboard
                                    </a>
                                </li>
                                <li class="kt-accordion-menu-item" data-kt-accordion-item="true">
                                    <button data-kt-accordion-toggle="true" id="menu_ex_users"
                                            aria-controls="menu_ex_users_sub" class="kt-accordion-menu-toggle">
                                        @svg('lucide-users', ['class' => 'lucide lucide-users kt-accordion-menu-icon'])
                                        Usuários
                                        @svg('lucide-chevron-down', ['class' => 'lucide lucide-chevron-down kt-accordion-menu-indicator'])
                                    </button>
                                    <div id="menu_ex_users_sub" class="kt-accordion-menu-content hidden"
                                         aria-labelledby="menu_ex_users">
                                        <ul class="kt-accordion-menu-sub">
                                            <li class="kt-accordion-menu-item" data-kt-accordion-item="true">
                                                <button data-kt-accordion-toggle="true" id="menu_ex_sub_1"
                                                        aria-controls="menu_ex_sub_1_sub"
                                                        class="kt-accordion-menu-toggle">
                                                    Sub menu 1
                                                    @svg('lucide-chevron-down', ['class' => 'lucide lucide-chevron-down kt-accordion-menu-indicator'])
                                                </button>
                                                <div id="menu_ex_sub_1_sub" class="kt-accordion-menu-content hidden"
                                                     aria-labelledby="menu_ex_sub_1">
                                                    <ul class="kt-accordion-menu-sub">
                                                        <li data-kt-accordion-item="true"><a href="#"
                                                                                             class="kt-accordion-menu-link">Link
                                                                1</a></li>
                                                        <li data-kt-accordion-item="true"><a href="#"
                                                                                             class="kt-accordion-menu-link">Link
                                                                2</a></li>
                                            ...
                                            <li class="kt-accordion-menu-item" data-kt-accordion-item="true">
                                                <button data-kt-accordion-toggle="true" id="menu_ex_sub_2"
                                                        aria-controls="menu_ex_sub_2_sub"
                                                        class="kt-accordion-menu-toggle">
                                                    Sub menu 2
                                                    @svg('lucide-chevron-down', ['class' => 'lucide lucide-chevron-down kt-accordion-menu-indicator'])
                                                </button>
                                                <div id="menu_ex_sub_2_sub" class="kt-accordion-menu-content hidden"
                                                     aria-labelledby="menu_ex_sub_2">
                                                    <ul class="kt-accordion-menu-sub">
                                                        <li data-kt-accordion-item="true"><a href="#"
                                                                                             class="kt-accordion-menu-link">Link
                                                                1</a></li>
                                ...
                                <li class="kt-accordion-menu-item" data-kt-accordion-item="true">
                                    <button data-kt-accordion-toggle="true" id="menu_ex_tasks"
                                            aria-controls="menu_ex_tasks_sub" class="kt-accordion-menu-toggle">
                                        @svg('lucide-list-todo', ['class' => 'lucide lucide-list-todo kt-accordion-menu-icon'])
                                        Tarefas
                                        @svg('lucide-chevron-down', ['class' => 'lucide lucide-chevron-down kt-accordion-menu-indicator'])
                                    </button>
                                    <div id="menu_ex_tasks_sub" class="kt-accordion-menu-content hidden"
                                         aria-labelledby="menu_ex_tasks">
                                        <ul class="kt-accordion-menu-sub">
                                            <li data-kt-accordion-item="true"><a href="#"
                                                                                 class="kt-accordion-menu-link">Abertas</a>
                                            </li>
                                            <li data-kt-accordion-item="true"><a href="#"
                                                                                 class="kt-accordion-menu-link">Concluídas</a>
                                            </li>
                                        </ul>
                                    </div>
                                </li>
                                <li data-kt-accordion-item="true">
                                    <a href="#" class="kt-accordion-menu-link">
                                        @svg('lucide-bell', ['class' => 'lucide lucide-bell kt-accordion-menu-icon'])
                                        Notificações
                                        <span
                                            class="kt-badge kt-badge-primary kt-badge-sm kt-badge-circle ms-auto">New</span>
                                    </a>
                                </li>
                                <li data-kt-accordion-item="true">
                                    <a href="#" class="kt-accordion-menu-link">
                                        @svg('lucide-settings', ['class' => 'lucide lucide-settings kt-accordion-menu-icon'])
                                        Configurações
                                    </a>
                                </li>
                            </ul>
