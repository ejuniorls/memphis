...
<div class="flex flex-col gap-6 p-6">
            ...
            <x-ui.modal id="modal_footer" title="Modal Title" top="5%">
                ...
                <x-slot:footer>
                    ...
                    <div class="flex gap-4">
                        <x-ui.button variant="secondary" data-kt-modal-dismiss="#modal_footer">Cancel</x-ui.button>
    ...
    <x-ui.card title="Scrollable">
        <div class="kt-card-content">
            ...
            <x-ui.modal id="modal_scrollable" title="Modal Title" top="10%" :scrollable="true" max-body-height="200px" footer-class="gap-2.5">
                <div class="rounded-lg bg-muted w-full h-[600px]"></div>
                <x-slot:footer>
                    <x-ui.button variant="secondary" data-kt-modal-dismiss="#modal_scrollable">Cancel</x-ui.button>
                    <x-ui.button>Submit</x-ui.button>
                </x-slot:footer>
            </x-ui.modal>
        </div>
    ...
    <x-ui.card title="Long Content">
        <div class="kt-card-content">
            ...
            <x-ui.modal id="modal_long" title="Modal Title" :center="true" class="max-h-[95%]">
                ...
                <x-slot:footer>
                    <div class="flex gap-4">
                        <x-ui.button variant="secondary" data-kt-modal-dismiss="#modal_long">Cancel</x-ui.button>
                        <x-ui.button>Submit</x-ui.button>
                    </div>
                </x-slot:footer>
            </x-ui.modal>
    ...
    <x-ui.card title="No Backdrop">
        <div class="kt-card-content">
            ...
            <x-ui.modal id="modal_no_backdrop" title="Modal Title" :center="true" :backdrop="false" class="border border-border">
                <div class="rounded-lg bg-muted w-full h-[200px]"></div>
            </x-ui.modal>
        </div>
    </x-ui.card>
    ...
    <x-ui.card title="Persistent">
        <div class="kt-card-content">
            ...
            <x-ui.modal id="modal_persistent" title="Modal Title" :fit="true" :center="true" :backdrop="false" :persistent="true">
                <div class="rounded-lg bg-muted w-full h-[200px]"></div>
            </x-ui.modal>
        </div>
    </x-ui.card>
    ...
    <x-ui.card title="Toggle Modals">
        <div class="kt-card-content">
            ...
            <x-ui.modal id="modal_toggle_one" title="Modal Title" top="10%" size="sm">
                ...
                <x-slot:footer>
                    <x-ui.button data-kt-modal-toggle="#modal_toggle_two">Launch Another Modal</x-ui.button>
                </x-slot:footer>
            </x-ui.modal>
            ...
            <x-ui.modal id="modal_toggle_two" title="Modal Title" top="5%">
                <div class="rounded-lg bg-muted w-full h-[250px]"></div>
                <x-slot:footer>
                    <x-ui.button data-kt-modal-toggle="#modal_toggle_one">Launch Previous Modal</x-ui.button>
                </x-slot:footer>
            </x-ui.modal>
        </div>
    </x-ui.card>
    ...
    <x-ui.card title="Overlay">
        <div class="kt-card-content">
            ...
            <x-ui.modal id="modal_overlay" title="Modal Title" :overlay="true" size="full" footer-align="end">
                <div class="rounded-lg bg-muted w-full h-[800px]"></div>
                <x-slot:footer>
                    <div class="flex gap-4">
                        <x-ui.button variant="secondary" data-kt-modal-dismiss="#modal_overlay">Cancel</x-ui.button>
                        <x-ui.button>Submit</x-ui.button>
                    </div>
                </x-slot:footer>
            </x-ui.modal>
