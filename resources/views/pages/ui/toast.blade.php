...
<div>
    <x-slot name="toolbar">
        <x-ui.breadcrumb>
            ...
            <x-ui.breadcrumb-item href="{{ route('pages::ui.showcase') }}">UI</x-ui.breadcrumb-item>
            <x-ui.breadcrumb-item :active="true">Toast</x-ui.breadcrumb-item>
        </x-ui.breadcrumb>
    </x-slot>
    ...
    <div class="py-6">
        ...
        <div class="mb-8">
            <h1 class="text-2xl font-bold text-mono">Toast</h1>
            <p class="text-sm text-secondary-foreground mt-1">Toasts are lightweight notifications designed to communicate ideas with minimal visual noise.</p>
        </div>
